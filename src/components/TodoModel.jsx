    ...
    isModelOpen && (
      <>
        <div className="bg-gray-300 bg-opacity-70 w-full h-screen fixed top-0 left-0 flex">
          <div className=" bg-gray-100 p-4 w-4/12 m-auto relative shadow-2xl">
            ...
            >
              ...
              <div className="btn-wrap mt-4">
                <button
                  type="submit"
                  className=" bg-green-400 px-4 py-1 text-white"
                >
                  Submit
                </button>
              </div>
            ...
            <button
              className="close-btn absolute -top-12 right-0 text-lg bg-white p-1 rounded-md"
